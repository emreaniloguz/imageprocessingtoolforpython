...
class HistCanvas(FigureCanvas):
    ...
    def __init__(self, graph_type,parent=None, width=5, height=4, dpi=100,facecolor=(141/255,141/255,141/255,1)):
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.rgb_pushbutton.clicked.connect(self.prepare_mask_page)
    ...
    def update_plot(self,graph_type):
        ...
        self.img = cv2.resize(img, (np.int(img.shape[1] / scale), np.int(img.shape[0] / scale)),
    ...
    def prepare_mask_page(self):
        self.ui.StackedWidget.setCurrentWidget(self.ui.masking_page)
        self.ui.masking_page.resize(1680,720)
        ...
        self.update_mask_plot(0)
        self.update_mask_plot(1)
        self.update_mask_plot(2)



    def update_mask_plot(self,graph_type):
        self.graph_type = graph_type
